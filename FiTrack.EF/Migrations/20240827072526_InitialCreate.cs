        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExercisePhoto = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentProgress = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Meals", x => x.NutritionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Set_WorkoutExercises_WorkoutId_ExerciseId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "ab2c779e-3030-439e-9052-f2b608e63a5c", "7cf3f27c-b368-4c36-bcb0-f0b4c7f4496b", "SuperAdmin", "SuperAdmin" },
                    { "e17a0bb8-5286-437d-92d2-1219b1ac8079", "c550884c-ceb4-4dbe-81cf-5e98407e6ec6", "User", "User" },
                    { "f9fc7163-df08-48b2-99d8-c2165ed19d24", "e817272c-2ee2-47c3-b01b-10ced6c26e2c", "Admin", "Admin" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Set_WorkoutId_ExerciseId",
                table: "Set",
